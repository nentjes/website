...
const content = {
  nl: {
    ...
    modelExplainer: {
      ...
      automationLabel: "Automatiseren door AI",
      automationTitle: "De basis op orde is nooit af.",
      automationIntro: "Ik heb het project Basis op orde bij iedere organisatie zien draaien — en nog nooit zien eindigen. AI-agents maken van dat eindeloze project continu onderhoud: ze kijken terug, vinden gaten en helpen ze herstellen.",
      automationTracks: [
    ...
    clients: ["KPN", "Hoogovens / Tata Steel", "VNU", "Overheid", "NKI-AVL", "Mensen in Nood", "Memisa", "Tempo-Team", "Randstad", "UWV", "GAK", "Reade", "Unicum Huisartsenzorg", "De Nederlandsche Bank", "Merem", "Woonmij Zaanstad", "Parteon", "Cegeka-DSA", "Bloemenveiling Aalsmeer", "Omroep Organisatie Groningen", "De Verzinkerij", "Biotics", "CSM", "ITCIS", "Ministerie van V&W"],
  ...
  en: {
    ...
    modelExplainer: {
      ...
      automationLabel: "Automation with AI",
      automationTitle: "The foundation is never finished.",
      automationIntro: "I have seen a Foundation in Order programme running in every organisation — and have never seen one truly end. AI agents turn that endless project into continuous maintenance: they look back, find gaps and help repair them.",
      automationTracks: [
    ...
    clients: ["KPN", "Hoogovens / Tata Steel", "VNU", "Government", "NKI-AVL", "Mensen in Nood", "Memisa", "Tempo-Team", "Randstad", "UWV", "GAK", "Reade", "Unicum Huisartsenzorg", "De Nederlandsche Bank", "Merem", "Woonmij Zaanstad", "Parteon", "Cegeka-DSA", "Bloemenveiling Aalsmeer", "Omroep Organisatie Groningen", "De Verzinkerij", "Biotics", "CSM", "ITCIS", "Ministry of Transport, Public Works and Water Management"],
